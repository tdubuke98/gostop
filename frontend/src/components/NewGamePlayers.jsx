...
export default function NewGamePlayers({ playing, setPlaying, setNextDisabled }) {
  ...
  return (
    <div className="flex flex-col flex-grow overflow-y-auto gap-4">
      ...
      {/* Responsive wrapper: column on mobile, row on larger screens */}
      <div className="flex flex-col lg:flex-row gap-4 h-full justify-between overflow-y-auto">
        ...
        <div className="flex flex-col gap-4 flex-grow shadow-inner">
          <h3 className="flex font-semibold text-white">Select Players</h3>

          <div className="flex rounded-lg bg-gray-700 overflow-y-auto shadow-inner max-h-64 lg:max-h-none">
        ...
        {/* Selected Players */}
        <div className="flex flex-col gap-4 flex-grow shadow-inner">
          <h3 className="flex font-semibold text-white">Selected Players</h3>
